    ...
    <li class="nav-item">
        ...
        <div id="taTpDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Candidate Management:</h6>
                <a class="collapse-item" href="{{ route('candidates.index') }}">List</a>
                <a class="collapse-item" href="{{ route('candidates.import') }}">Import Data</a>
            </div>
        </div>
    </li>
